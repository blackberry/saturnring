...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AAGroup.target'
        db.add_column(u'ssdfrontend_aagroup', 'target',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ssdfrontend.Target'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Target.aagroup'
        db.delete_column(u'ssdfrontend_target', 'aagroup_id')


    def backwards(self, orm):
        # Deleting field 'AAGroup.target'
        db.delete_column(u'ssdfrontend_aagroup', 'target_id')

        # Adding field 'Target.aagroup'
        db.add_column(u'ssdfrontend_target', 'aagroup',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ssdfrontend.AAGroup'], null=True, blank=True),
                      keep_default=False)
