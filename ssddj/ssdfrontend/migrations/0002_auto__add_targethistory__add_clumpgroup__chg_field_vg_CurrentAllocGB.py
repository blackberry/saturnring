...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VG.CurrentAllocGB'
        db.alter_column(u'ssdfrontend_vg', 'CurrentAllocGB', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'VG.CurrentAllocGB'
        db.alter_column(u'ssdfrontend_vg', 'CurrentAllocGB', self.gf('django.db.models.fields.FloatField')())
