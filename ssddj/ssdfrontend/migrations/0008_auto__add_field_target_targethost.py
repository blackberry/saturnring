...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Target.targethost'
        db.add_column(u'ssdfrontend_target', 'targethost',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['ssdfrontend.StorageHost']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Target.targethost'
        db.delete_column(u'ssdfrontend_target', 'targethost_id')
