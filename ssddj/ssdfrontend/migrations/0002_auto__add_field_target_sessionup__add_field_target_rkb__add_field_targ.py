...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Target.sessionup'
        db.add_column(u'ssdfrontend_target', 'sessionup',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Target.rkb'
        db.add_column(u'ssdfrontend_target', 'rkb',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Target.wkb'
        db.add_column(u'ssdfrontend_target', 'wkb',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Target.sessionup'
        db.delete_column(u'ssdfrontend_target', 'sessionup')

        # Deleting field 'Target.rkb'
        db.delete_column(u'ssdfrontend_target', 'rkb')

        # Deleting field 'Target.wkb'
        db.delete_column(u'ssdfrontend_target', 'wkb')
    ...
    models = {
        ...
        u'ssdfrontend.target': {
            ...
            'rkb': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'wkb': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'ssdfrontend.vg': {
