...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Target.rkbpm'
        db.add_column(u'ssdfrontend_target', 'rkbpm',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Target.wkbpm'
        db.add_column(u'ssdfrontend_target', 'wkbpm',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Target.rkbpm'
        db.delete_column(u'ssdfrontend_target', 'rkbpm')

        # Deleting field 'Target.wkbpm'
        db.delete_column(u'ssdfrontend_target', 'wkbpm')
    ...
    models = {
        ...
        u'ssdfrontend.target': {
            ...
            'rkbpm': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            ...
            'wkbpm': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        u'ssdfrontend.vg': {
