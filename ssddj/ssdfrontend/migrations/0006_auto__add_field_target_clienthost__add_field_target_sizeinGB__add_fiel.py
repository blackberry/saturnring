...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Target.clienthost'
        db.add_column(u'ssdfrontend_target', 'clienthost',
                      self.gf('django.db.models.fields.CharField')(default='nohost', max_length=100),
                      keep_default=False)

        # Adding field 'Target.sizeinGB'
        db.add_column(u'ssdfrontend_target', 'sizeinGB',
        ...
        db.add_column(u'ssdfrontend_target', 'dateCreated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 3, 14, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Target.clienthost'
        db.delete_column(u'ssdfrontend_target', 'clienthost')

        # Deleting field 'Target.sizeinGB'
        db.delete_column(u'ssdfrontend_target', 'sizeinGB')
    ...
    models = {
        ...
        u'ssdfrontend.target': {
            ...
            'sizeinGB': ('django.db.models.fields.IntegerField', [], {})
        },
        u'ssdfrontend.vg': {
            'Meta': {'object_name': 'VG'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
