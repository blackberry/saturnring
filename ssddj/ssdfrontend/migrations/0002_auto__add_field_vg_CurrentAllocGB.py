...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VG.CurrentAllocGB'
        db.add_column(u'ssdfrontend_vg', 'CurrentAllocGB',
                      self.gf('django.db.models.fields.FloatField')(default=-100.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VG.CurrentAllocGB'
        db.delete_column(u'ssdfrontend_vg', 'CurrentAllocGB')
